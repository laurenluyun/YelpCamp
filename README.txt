YelpCamp
Full-stack web application for campsite reviews with full CRUD functionalities, user authorization & authentication(express session, passport), geocoding and maps(Mapbox).
